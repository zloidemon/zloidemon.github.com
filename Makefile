...
help:
	...
	@echo ""
	@echo "Targets:"
	@echo "  build     Full build (posts, archives, tags, index, atom, cname, assets, 404, favicon)"
...
build: posts archives tags index atom cname assets assets-posts 404 favicon
...
.PHONY: help build posts archives tags index atom cname assets assets-posts 404 favicon clean serve test draft deploy
